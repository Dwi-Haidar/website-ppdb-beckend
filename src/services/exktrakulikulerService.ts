...
export const createExktrakulikuler = async (payload: IEkstraKulikuler, files: { [fieldname: string]: Express.Multer.File[] }) => {
    try {
        console.log(files);
...
export const updateEktrakulikuler = async (id: number, payload: IEkstraKulikuler, files: { [fieldname: string]: Express.Multer.File[] }) => {
    try {
